...
class HotelRooms(models.Model):
    ...
    room_no_id = fields.Integer(string="Room Number",required = True,group_operator=False)
    ...
    rent = fields.Monetary(string="Rent", currency_field="currency_id",group_operator=False)
